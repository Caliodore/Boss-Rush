...
{ 
    public abstract class StC4 : MonoBehaviour
    {
        ...
        public UnityEvent StateEntering = new UnityEvent();
        public UnityEvent StateExiting = new UnityEvent();
        ...
        public virtual void OnAwake()
        {
            ...
            StateEntering?.AddListener(() => C4_HostBrain.BossAnimManager.UpdateStateTriggers());
            StateEntering?.AddListener(() => C4_HostBrain.BossAnimManager.ClearInts());
            StateEntering?.AddListener(() => C4_HostBrain.BossAnimManager.ChooseAnimBhvr());
        }
